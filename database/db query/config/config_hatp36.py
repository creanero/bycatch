"""Per-target configuration template for HAT-P-36b.
...
RAW_DATA_FOLDER = "raw_images_hatp36"
ALIGNED_FOLDER = "aligned_images_hatp36"

# TODO: Replace these placeholders with real (x, y) tuples.
# Convention: target first, then comparison stars.
TARGET_POSITIONS = (
    (0.0, 0.0),  # TODO target star (HAT-P-36b)
